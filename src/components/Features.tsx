      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-[#8E8E93] text-lg max-w-xl mx-auto">
            Herramientas simples pero poderosas, diseñadas para emprendedores
            que quieren resultados.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <div
              key={index}
              className="group bg-[#141414] border border-[#2C2C2E] rounded-2xl p-8 hover:border-[#1D9E75]/40 transition-all duration-300 hover:-translate-y-1"
            >
              {/* Icon */}
              <div className="w-14 h-14 rounded-xl bg-[#1D9E75]/10 flex items-center justify-center text-[#1D9E75] mb-6 group-hover:bg-[#1D9E75]/20 transition-colors">
                {feature.icon}
              </div>
